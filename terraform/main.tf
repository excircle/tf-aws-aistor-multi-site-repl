...
module "minio-us-west-2-cluster1" {
  ...
  system_user               = "ubuntu"
  hosts                     = 6                                     # Number of nodes with MinIO installed
...
# module "minio-us-west-2-cluster3" {
#   source = "github.com/excircle/tf-aws-minio-cluster"
#   providers = {
#     aws = aws.us-west-2
#   }

#   application_name          = "minio-us-west-2-cluster3"
#   system_user               = "ubuntu"
#   hosts                     = 2                                     # Number of nodes with MinIO installed
#   vpc_id                    = module.minio-vpc-west-2.vpc_id
#   minio_license             = var.minio_license                     # Required only if using: minio_flavor = "aistor"
...
# module "minio-west-2-cluster3-disks" {
...
#   minio_hosts = module.minio-us-west-2-cluster3.minio_host_info
#   disk_names = module.minio-us-west-2-cluster3.disk-names
#   ebs_storage_volume_size = module.minio-us-west-2-cluster3.ebs_storage_volume_size
# }